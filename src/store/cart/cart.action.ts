...
const addCartItem = (
  cartItems: CartItem[], productToAdd: CategoryItem): CartItem[] => {
...
const removeCartItem = (
  cartItems: CartItem[], cartItemToRemove: CartItem): CartItem[] => {
  const existingCartItem = cartItems.find(
...
const clearCartItem = (
  cartItems: CartItem[],
  cartItemToClear: CartItem): CartItem[] => cartItems.filter(
...
export const setCartItems = withMatcher(
  (cartItems: CartItem[]): SetCartItems => createAction(
    CART_ACTIONS_TYPE.SET_CART_ITEMS, cartItems))
